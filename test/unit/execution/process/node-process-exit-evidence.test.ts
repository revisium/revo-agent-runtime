...
test('retains the authentic natural exit through confirmed cleanup', async () => {
...
test('retains a successful exit and delivers both child output channels before cleanup', async () => {
