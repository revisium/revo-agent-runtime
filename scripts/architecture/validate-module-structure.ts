...
const allowedPrivateTestImports = new Set([
  ...
  'test/support/lifecycle-conformance/create-accepted-invocation-lifecycle-subject.ts->src/runtime/execution/output-preparation-attempt/index.ts',
  'test/unit/runtime/execution/finalize-invocation-outcome.test.ts->src/runtime/execution/output-preparation-attempt/index.ts',
  'test/unit/runtime/execution/lifecycle.test.ts->src/runtime/execution/output-preparation-attempt/index.ts',
  ...
  'test/unit/platform/node-posix-terminal-publication-port.test.ts->src/runtime/execution/output-preparation-attempt/consumed-output-preparation-material.ts',
