...
| `diagnostics`                     | Portable bounded and redacted provider diagnostic normalization                                             | Contracts                                                                |
| `configuration`                   | Bounded immutable catalog normalization, selection decoding, derived model/provider view, and revision      | Contracts, canonical bytes, and Node crypto                              |
